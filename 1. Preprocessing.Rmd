...
# The AIC parameter for both model are quite similar, although the m0.c is slightly better.

# We've tried to run the anova test, but due to the divergence of the dimension, it can not run properly.
