...
# Execute catdes function to find the correlation between the variables against our qualitative target.
...
```{r}
# First, let's split the dataset into training and testing. We can consider that 70% of data will be used for training purpose.
