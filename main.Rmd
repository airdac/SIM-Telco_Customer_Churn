...
The model is composed by the tenure of the customer, the amount of bill they pay monthly, the  contract period that they have with the company, the internet service they own and then the payment method.

Bear in mind that 0 denotes "No Churn" and 1 denotes "Churn Yes", where clients with lower scores are less liketo to leave the company.

Examining the coefficients of m5, client with longer seniority and contract type are more comfortable with the company and less likely to churn.
